# campomaior-pi - Configuração Kubernetes

## 📋 Informações do Ambiente

- **Namespace**: `campomaior-pi`
- **Aplicação**: campomaior
- **Domínio**: `campomaior.saude.pi.gov.br`
- **Database**: `tenant_cuidar_campo_maior_db`
- **Ambiente**: Production
...
kubectl get all,pvc,ingress -n campomaior-pi

# Ver pods
kubectl get pods -n campomaior-pi

# Ver logs
kubectl logs -n campomaior-pi deployment/campomaior -f
kubectl logs -n campomaior-pi deployment/sidekiq -f

# Port-forward para testar localmente
kubectl port-forward -n campomaior-pi deployment/campomaior 3030:3000
...
```
Tipo: CNAME
Nome: campomaior.saude.pi.gov.br
...
```bash
kubectl exec -n campomaior-pi deployment/campomaior -- bundle exec rails runner \
