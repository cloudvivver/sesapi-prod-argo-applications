# picos-pi - Configuração Kubernetes

## 📋 Informações do Ambiente

- **Namespace**: `picos-pi`
- **Aplicação**: picos
- **Domínio**: `picos.saude.pi.gov.br`
- **Database**: `tenant_cuidar_picos_db`
- **Ambiente**: Production
...
kubectl get all,pvc,ingress -n picos-pi

# Ver pods
kubectl get pods -n picos-pi

# Ver logs
kubectl logs -n picos-pi deployment/picos -f
kubectl logs -n picos-pi deployment/sidekiq -f

# Port-forward para testar localmente
kubectl port-forward -n picos-pi deployment/picos 3030:3000
...
```bash
kubectl exec -n picos-pi deployment/picos -- bundle exec rails runner \
