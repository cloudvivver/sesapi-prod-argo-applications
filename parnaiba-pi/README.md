# parnaiba-pi - Configuração Kubernetes

## 📋 Informações do Ambiente

- **Namespace**: `parnaiba-pi`
- **Aplicação**: parnaiba
- **Domínio**: `parnaiba.saude.pi.gov.br`
- **Database**: `tenant_cuidar_parnaiba_db`
- **Ambiente**: Production
...
kubectl get all,pvc,ingress -n parnaiba-pi

# Ver pods
kubectl get pods -n parnaiba-pi

# Ver logs
kubectl logs -n parnaiba-pi deployment/parnaiba -f
kubectl logs -n parnaiba-pi deployment/sidekiq -f

# Port-forward para testar localmente
kubectl port-forward -n parnaiba-pi deployment/parnaiba 3030:3000
...
```bash
kubectl exec -n parnaiba-pi deployment/parnaiba -- bundle exec rails runner \
